...
# Backwards compatibility aliases - deprecated, use factory functions instead
class TTSRateLimiter(RateLimiter):
    """Rate limiter specifically for TTS requests.

    Deprecated: Use tts_rate_limiter() function instead.
    """

    def __init__(self):
        super().__init__(max_requests=10, window_seconds=60, block_duration=300)


class TranscriptionRateLimiter(RateLimiter):
    """Rate limiter specifically for transcription requests.

    Deprecated: Use transcription_rate_limiter() function instead.
    """

    def __init__(self):
        super().__init__(max_requests=20, window_seconds=60, block_duration=300)


class VideoRateLimiter(RateLimiter):
    """Rate limiter for video processing operations.

    Deprecated: Use video_rate_limiter() function instead.
    """

    def __init__(self):
        super().__init__(max_requests=3, window_seconds=300, block_duration=600)


class VisionRateLimiter(RateLimiter):
    """Rate limiter for vision/image processing.

    Deprecated: Use vision_rate_limiter() function instead.
    """
